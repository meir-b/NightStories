...
export const BookSelection = () => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-start pt-20 bg-gradient-to-b from-black/80 to-[#0a1829]">
      <div className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 max-w-7xl">
        {books.map((book) => {
          // Determine if title or description is in Hebrew
          ...
          return (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <h3 className={`text-[#e2c87d] text-2xl font-medium mb-2 ${isTitleHebrew ? 'font-hebrew text-right' : ''}`}>
                  {book.title}
                </h3>
                
                {/* Hebrew RTL support for description */}
                <p className={`text-white/90 text-sm mb-6 ${isDescriptionHebrew ? 'font-hebrew text-right' : ''}`}>
                  {book.description}
                </p>
